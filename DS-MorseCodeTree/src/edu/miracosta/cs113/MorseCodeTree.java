 ...
 * @version 1.0
 */
public class MorseCodeTree extends BinaryTree<Character>{ //NOTE: it would be a binary tree because you don't need to organize the nodes, you just need to find them based off the mores code given
